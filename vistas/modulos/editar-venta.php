...
if(isset($_GET["idVenta"])){
    $valor = $_GET["idVenta"];
}else if(isset($_POST["editarVenta"])){
...
?>
      <input type="hidden" name="editarVenta" value="<?php echo $venta["id"]; ?>">          
                ...
                <div class="form-group row">
                  ...
                  <div class="col-xs-6" style="padding-right:0px">
                     ...
                     <div class="input-group">
                      ...
                      <select class="form-control" id="nuevoMetodoPago" name="listaMetodoPago" required>
