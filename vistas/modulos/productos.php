...
<div id="modalAgregarProducto" class="modal fade" role="dialog">
  ...
  <div class="input-group">
    ...
    <input type="number" class="form-control input-lg" name="nuevoStockMinimo" min="0" placeholder="Stock Mínimo (Alerta)" required>
  </div>
</div>
...
<div class="form-group">
  <div class="input-group">
    ...
    <select class="form-control" name="nuevoTipoSanitario">
      ...
      <option value="Medicamento">Medicamento</option>
            ...
            <div class="form-group">
              <div class="input-group">
                ...
                <input type="date" class="form-control input-lg" name="nuevaFechaVencimiento">
              </div>
            </div>
