...
class ModeloCotizaciones {
    ...
    /*=============================================
    GUARDAR ENCABEZADO DE COTIZACIÓN / PEDIDO
    =============================================*/
    ...
    /*=============================================
    EDITAR ENCABEZADO DE COTIZACIÓN / PEDIDO
    =============================================*/
    static public function mdlEditarEncabezado($tabla, $datos) {
    ...
    /*=============================================
    GUARDAR DETALLE DE COTIZACIÓN / PEDIDO
    =============================================*/
    ...
    /*=============================================
    BORRAR DETALLES DE UN DOCUMENTO
    =============================================*/
    static public function mdlBorrarDetalles($tabla, $idDocto) {

        $stmt = Conexion::conectar()->prepare("DELETE FROM $tabla WHERE id_docto = :id_docto");
    ...
    =============================================*/
    static public function mdlEliminarCotizacion($tabla, $idCotizacion) {
    ...
    /*=============================================
    MOSTRAR ENCABEZADO DE COTIZACIÓN
    =============================================*/
