...
class ControladorGastos {
    ...
    static public function ctrCrearGasto() {
        ...
        if (isset($_POST["descripcionGasto"])) {
            ...
            try {
                ...
                $descripcion = isset($_POST["descripcionGasto"]) ? trim(strip_tags($_POST["descripcionGasto"])) : "";
    ...
    static public function ctrEditarGasto() {
        ...
        if (isset($_POST["idGastoEditar"])) {
            ...
            try {
                ...
                $descripcion = isset($_POST["descripcionGastoEditar"]) ? trim(strip_tags($_POST["descripcionGastoEditar"])) : "";
                ...
                if ($movimientoCaja && is_array($movimientoCaja)) {
                    ...
                    // Formato seguro de fecha/hora para el movimiento
                    $fechaMovimiento = (strlen($fecha) === 10) ? $fecha . " 00:00:00" : $fecha;
    ...
    static public function ctrMostrarGastoPorId($id) {
        return ModeloGastos::mdlMostrarGastoPorId("gastos", (int)$id);
    }
