...
class ControladorClientes{
  ...
  if (
    ...
    (empty($_POST["nuevoDocumentoId"]) || preg_match('/^[0-9]+$/', $_POST["nuevoDocumentoId"])) &&
    ...
    (empty($_POST["nuevaDireccion"]) || preg_match('/^[#\.\-a-zA-Z0-9 ]+$/', $_POST["nuevaDireccion"]))
  ) {
...
exit();
    ...
    (empty($_POST["editarDocumentoId"]) || preg_match('/^[0-9]+$/', $_POST["editarDocumentoId"])) &&
    ...
    (empty($_POST["editarDireccion"]) || preg_match('/^[#\.\-a-zA-Z0-9 ]+$/', $_POST["editarDireccion"]))
){
